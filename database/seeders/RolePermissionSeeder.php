...
class RolePermissionSeeder extends Seeder
{
    ...
    public function permissions(): Collection
    {
        ...
        return collect([
            ...
            [
                'name' => 'browse-zakat',
                'display_name' => 'browse_zakat',
                'group' => $groups['mosque_charity'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'browse_zakat',
            ],
            [
                'name' => 'read-zakat',
                'display_name' => 'read_zakat',
                'group' => $groups['mosque_charity'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'read_zakat',
            ],
            [
                'name' => 'edit-zakat',
                'display_name' => 'edit_zakat',
                'group' => $groups['mosque_charity'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'edit_zakat',
            ],
            [
                'name' => 'add-zakat',
                'display_name' => 'add_zakat',
                'group' => $groups['mosque_charity'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'add_zakat',
            ],
            [
                'name' => 'delete-zakat',
                'display_name' => 'delete_zakat',
                'group' => $groups['mosque_charity'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'delete_zakat',
            ],
            [
                'name' => 'browse-qurban',
