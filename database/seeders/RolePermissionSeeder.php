...
class RolePermissionSeeder extends Seeder
{
    ...
    private function syncRolesPermissions()
    {
        $roles_permissions = [
            'superadmin' => [
                ...
                'add-mosque-charity-distributions',
                'delete-mosque-charity-distributions',
                // charity distribution recipients
                'browse-mosque-charity-distribution-recipients',
                'read-mosque-charity-distribution-recipients',
    ...
    public function groups(): Collection
    {
        return collect([
            ...
            'mosque_charity_distributions' => 'mosque_charity_distributions',
            'mosque_charity_distribution_recipients' => 'mosque_charity_distribution_recipients',
    ...
    public function permissions(): Collection
    {
        ...
        return collect([
            ...
            [
                'name' => 'browse-mosque-charity-distributions',
                'display_name' => 'browse_mosque_charity_distributions',
                'group' => $groups['mosque_charity_distributions'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'browse_mosque_charity_distributions',
            ],
            [
                'name' => 'read-mosque-charity-distributions',
                'display_name' => 'read_mosque_charity_distributions',
                'group' => $groups['mosque_charity_distributions'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'read_mosque_charity_distributions',
            ],
            [
                'name' => 'edit-mosque-charity-distributions',
                'display_name' => 'edit_mosque_charity_distributions',
                'group' => $groups['mosque_charity_distributions'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'edit_mosque_charity_distributions',
            ],
            [
                'name' => 'add-mosque-charity-distributions',
                'display_name' => 'add_mosque_charity_distributions',
                'group' => $groups['mosque_charity_distributions'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'add_mosque_charity_distributions',
            ],
            [
                'name' => 'delete-mosque-charity-distributions',
                'display_name' => 'delete_mosque_charity_distributions',
                'group' => $groups['mosque_charity_distributions'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'delete_mosque_charity_distributions',
            ],
            [
                'name' => 'browse-mosque-charity-distribution-recipients',
                'display_name' => 'browse_mosque_charity_distribution_recipients',
                'group' => $groups['mosque_charity_distribution_recipients'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'browse_mosque_charity_distribution_recipients',
            ],
            [
                'name' => 'read-mosque-charity-distribution-recipients',
                'display_name' => 'read_mosque_charity_distribution_recipients',
                'group' => $groups['mosque_charity_distribution_recipients'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'read_mosque_charity_distribution_recipients',
            ],
            [
                'name' => 'edit-mosque-charity-distribution-recipients',
                'display_name' => 'edit_mosque_charity_distribution_recipients',
                'group' => $groups['mosque_charity_distribution_recipients'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'edit_mosque_charity_distribution_recipients',
            ],
            [
                'name' => 'add-mosque-charity-distribution-recipients',
                'display_name' => 'add_mosque_charity_distribution_recipients',
                'group' => $groups['mosque_charity_distribution_recipients'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'add_mosque_charity_distribution_recipients',
            ],
            [
                'name' => 'delete-mosque-charity-distribution-recipients',
                'display_name' => 'delete_mosque_charity_distribution_recipients',
                'group' => $groups['mosque_charity_distribution_recipients'],
                'scope' => 'partner',
                'context' => 'mosque',
                'description' => 'delete_mosque_charity_distribution_recipients',
            ],
            [
