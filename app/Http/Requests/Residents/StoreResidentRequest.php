...
class StoreResidentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => [$isPartnerContext ? 'nullable' : 'required', 'email', 'max:255', 'unique:users,email'],
            'username' => [$isPartnerContext ? 'nullable' : 'required', 'string', 'max:255', 'unique:users,username'],
