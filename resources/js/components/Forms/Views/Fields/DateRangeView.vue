    ...
    data() {
        return {
            ...
            config: {
                ...
                dateFormat: "Y-m-d",
                defaultDate: this.field.prefill,
                minDate: null,
                maxDate: null,
                disable: [],
                inline: false,
    ...
    methods: {
        ...
        updateConfig: function () {
            if (this.field.prefill) {
                ...
                this.config.defaultDate = this.field.prefill;
                this.configInlineWeek.defaultDate = this.field.prefill;
                this.configInlineNotWeek.defaultDate = this.field.prefill;
                this.configNotInlineWeek.defaultDate = this.field.prefill;
            } else {
                this.value[this.field.id] = null;

                this.config.defaultDate = null;
                this.configInlineWeek.defaultDate = null;
                this.configInlineNotWeek.defaultDate = null;
                this.configNotInlineWeek.defaultDate = null;
            }
