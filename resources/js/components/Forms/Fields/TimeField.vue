<template>
    ...
    <div class="row">
        <div class="col-md-12">
            <div :class="['mb-3', errors.prefill ? 'flatpickr-is-invalid' : '']">
                <div class="form-label fw-medium">{{ trans.prefill_value }}</div>
                <div class="input-group">
                    <flat-pickr
                        v-model="value.prefill"
                        :config="config"
                        id="prefill"
                        key="prefill"
                        class="form-control"
                    />
                    <button class="btn btn-outline-primary" type="button" id="prefill" data-clear>
                        <i class="ri-close-line fs-13"/>
                    </button>
                </div>
                <span class="invalid-feedback d-block" v-if="errors.prefill">
...
export default {
    ...
    computed: {
        actionOptions() {
            ...
            let actions = collect(fieldActions[this.formStore.data.formFields.time]);
