<template>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                ...
                <input type="number" id="prefill" v-model="value.prefill" :class="['form-control', errors.prefill ? 'is-invalid' : '']">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                <label for="min_number" class="form-label">{{ trans.min_number }}</label>
                <input type="number" id="min_number" v-model="value.min_number" :class="['form-control', errors.min_number ? 'is-invalid' : '']">
                <span class="invalid-feedback" v-if="errors.min_number"><strong>{{ errors.min_number[0] }}</strong></span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                <label for="max_number" class="form-label">{{ trans.max_number }}</label>
                <input type="number" id="max_number" v-model="value.max_number" :class="['form-control', errors.max_number ? 'is-invalid' : '']">
                <span class="invalid-feedback" v-if="errors.max_number"><strong>{{ errors.max_number[0] }}</strong></span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                <label for="step_number" class="form-label">{{ trans.step_number }}</label>
                <input type="number" id="step_number" v-model="value.step_number" :class="['form-control', errors.step_number ? 'is-invalid' : '']">
                <span class="invalid-feedback" v-if="errors.step_number"><strong>{{ errors.step_number[0] }}</strong></span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                <label for="number_pattern" class="form-label">
                    {{ trans.number_pattern }}
                    <RegexLink/>
                </label>
                <input type="text" id="number_pattern" v-model="value.number_pattern" :class="['form-control', errors.number_pattern ? 'is-invalid' : '']">
                <span class="invalid-feedback" v-if="errors.number_pattern"><strong>{{ errors.number_pattern[0] }}</strong></span>
            </div>
        </div>
    </div>
...
export default {
    ...
    computed: {
        actionOptions() {
            ...
            let actions = collect(fieldActions[this.formStore.data.formFields.number]);
