<template>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="mb-3">
                <label for="text" class="form-label">{{ trans.text }} <span class="text-danger">*</span></label>
                <textarea id="text" name="text" v-model="value.text"
                          :class="['form-control', errors.text ? 'is-invalid' : '']"></textarea>
...
export default {
    ...
    computed: {
        actionOptions() {
            ...
            let actions = collect(fieldActions[this.formStore.data.formFields.paragraph]);
