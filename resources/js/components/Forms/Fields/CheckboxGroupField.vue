<template>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="mb-1">
                <div class="form-label fw-medium">{{ trans.style }}</div>
            </div>
        </div>
        ...
        <div id="styles">
                ...
                <div class="form-check form-switch mb-3">
                    ...
                    <label for="horizontal" class="form-check-label">
                        <div class="d-flex align-middle">
                            ...
                            <i class="ri-information-line ms-1" v-tooltip data-bs-placement="right"
                               :title="trans.make_checkboxes_horizontally_in_a_single_row"></i>
                        </div>
                    </label>
                </div>
                ...
                <div class="form-check form-switch mb-3">
                    ...
                    <label for="outline" class="form-check-label">
                        <div class="d-flex align-middle">
                            ...
                            <i class="ri-information-line ms-1" v-tooltip data-bs-placement="right"
                               :title="trans.change_checkboxes_to_outlined_styles"></i>
                        </div>
                    </label>
                </div>
            ...
            <div class="col-md-12">
                <div class="form-check form-switch mb-3">
                    <input type="checkbox" :class="['form-check-input', errors.toggle_switch ? 'is-invalid' : '']"
                           id="toggle_switch" v-model="value.toggle_switch" :value="value.toggle_switch">
                    <label for="toggle_switch" class="form-check-label">
                        <div class="d-flex align-middle">
                            <span>{{ trans.toggle_switch }}</span>
                            <i class="ri-information-line ms-1" v-tooltip data-bs-placement="right"
                               :title="trans.toggle_switch_mode"></i>
                        </div>
                    </label>
                </div>
                <div class="invalid-feedback d-block mb-3" v-if="errors.toggle_switch">
                    <strong>{{ errors.toggle_switch[0] }}</strong>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="mb-3">
                ...
                <div class="btn-group" role="group" aria-label="Data source">
                    <template v-for="(input, index) in dataSourceInputNames[this.formStore.data.formFields.checkbox_group]">
        ...
        <div class="col-md-12" v-if="value.data_source === dataSourceInput.list">
            <div class="mb-3">
                ...
                <template v-if="value.options.length > 0">
                    <div v-for="(option, index) in value.options" class="border rounded mb-3 p-3" :key="index">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label :for="`tooltip_`+index" class="form-label">
                                        <div class="d-flex align-items-center">
                                            {{ trans.tooltips }}
                                            <i class="ri-information-line ms-1" v-tooltip data-bs-placement="right"
                                               :title="trans.tooltips_is_small_pop_up_box_that_appears_when_the_user_moves_the_mouse_pointer_over_an_element"></i>
                                        </div>
                                    </label>
                                    <input type="text" :id="`tooltip_`+index" v-model="option.tooltip"
                                           :class="['form-control', errors['options.'+index+'.tooltip'] ? 'is-invalid' : '']">
                                    <span class="invalid-feedback" v-if="errors['options.'+index+'.tooltip']">
                                        <strong>{{ errors['options.' + index + '.tooltip'][0] }}</strong>
                                    </span>
                                </div>
                            </div>
        ...
        <div class="col-md-12" v-if="value.data_source === dataSourceInput.url">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-check form-switch mb-3">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="url" class="form-label">
                                    ...
                                    <span class="text-muted fs-12 ms-1" v-if="value.use_current_url">
                                        ({{ appUrl }})
                                    </span>
                                </label>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="url_value" v-model="value.url_value"
                               :class="['form-control', errors.url_value ? 'is-invalid' : '']"
                               :placeholder="trans.value_key">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="url_label" v-model="value.url_label"
                               :class="['form-control', errors.url_label ? 'is-invalid' : '']"
                               :placeholder="trans.label_key">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="url_tooltip" class="form-label">
                            {{ trans.tooltips }}
                        </label>
                        <input type="text" id="url_tooltip" v-model="value.url_tooltip"
                               :class="['form-control', errors.url_tooltip ? 'is-invalid' : '']"
                               :placeholder="trans.tooltip_key">
                        <span class="invalid-feedback" v-if="errors.url_tooltip">
                            <strong>{{ errors.url_tooltip[0] }}</strong>
                        </span>
                    </div>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            trans: {
                ...
                make_checkboxes_horizontally_in_a_single_row: trans.make_checkboxes_horizontally_in_a_single_row,
                change_checkboxes_to_outlined_styles: trans.change_checkboxes_to_outlined_styles,
                options: trans.options,
                add_option: trans.add_option,
                the_option_list_is_empty: trans.the_option_list_is_empty,
                value: trans.value,
                disabled: trans.disabled,
                toggle_switch: trans.toggle_switch,
                toggle_switch_mode: trans.toggle_switch_mode,
                tooltips: trans.tooltips,
                tooltips_is_small_pop_up_box_that_appears_when_the_user_moves_the_mouse_pointer_over_an_element: trans.tooltips_is_small_pop_up_box_that_appears_when_the_user_moves_the_mouse_pointer_over_an_element,
                use_current_url: trans.use_current_url,
                url: trans.url,
                value_key: trans.value_key,
                label_key: trans.label_key,
                tooltip_key: trans.tooltip_key,
    ...
    computed: {
        actionOptions() {
            ...
            let actions = collect(fieldActions[this.formStore.data.formFields.checkbox_group]);
