<template>
    <div :class="field.width">
        <div class="mb-3">
            ...
            <input type="tel" v-model="value[field.id]" :id="field.id"
                   :class="['form-control', form.errors[field.id] ? 'is-invalid' : '']" :minlength="field.minlength"
                   :maxlength="field.maxlength" :placeholder="field.placeholder" :disabled="disableField()">
