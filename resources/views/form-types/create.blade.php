...
@section('title', __('messages.create_form_type'))

@section('breadcrumbs', Breadcrumbs::render('form-types.create'))
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom-dashed align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('messages.create_form_type') }}</h4>
                </div>
                <div class="card-body">
...
@push('scripts')
    <!-- vue -->
    @vite('resources/js/views/form-types/create.js')
@endpush
