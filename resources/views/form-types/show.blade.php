...
@section('title', __('messages.view_form_type'))

@section('breadcrumbs', Breadcrumbs::render('form-types.show', $model))
                    ...
                    <div class="row g-4 align-items-center gy-3">
                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex gap-1 flex-wrap">
                                @can('edit-form-types')
                                    <a href="{{ route('form-types.edit', ['form_type' => $model->id]) }}"
                                    ...
                                    <div id="delete-confirmation">
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
                                            ...
                                            <button class="btn btn-sm btn-danger btn-icon"
                                                    ...
                                                    @click.once="triggerDelete('{{ route('form-types.destroy', ['form_type' => $model->id]) }}')">
