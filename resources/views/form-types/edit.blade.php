...
@section('title', __('messages.edit_form_type'))

@section('breadcrumbs', Breadcrumbs::render('form-types.edit', $model))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom-dashed align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('messages.edit_form_type') }}</h4>
                </div>
                <div class="card-body">
...
@push('scripts')
    ...
    <!-- vue -->
    @vite('resources/js/views/form-types/edit.js')
@endpush
