<div>
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h6 class="mb-0">{{ __('messages.charity_type_sources') }}</h6>
                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" wire:model="is_active" id="charity-type-source-active">
                            <label class="form-check-label" for="charity-type-source-active">
                                {{ __('messages.active') }}
                            </label>
                        </div>
