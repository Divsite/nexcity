...
@section('title', __('messages.view_group'))

@section('breadcrumbs', Breadcrumbs::render('groups.show', $model))
                    ...
                    <div class="row g-4 align-items-center gy-3">
                        ...
                        <div class="col-sm-auto">
                            <div class="d-flex gap-1 flex-wrap">
                                @can('edit-groups')
                                    <a href="{{ route('groups.edit', ['group' => $model->id]) }}"
                                    ...
                                    <div id="delete-confirmation">
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
                                            ...
                                            <button class="btn btn-sm btn-danger btn-icon"
                                                    ...
                                                    @click.once="triggerDelete('{{ route('groups.destroy', ['group' => $model->id]) }}')">
                ...
                <div class="card-body">
                    <div class="table-responsive table-card mt-4">
                        <table class="table table-bordered table-striped table-hover mb-0">
                            ...
                            <tr>
                                <td class="fw-medium text-end">{{ __('messages.slug') }}</td>
                                <td>{{ $model->slug }}</td>
                            </tr>
                            <tr>
