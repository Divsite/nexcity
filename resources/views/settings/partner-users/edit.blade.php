                        ...
                        <div class="row mt-2">
                            <div class="col-xxl-3 mb-3">
                                <div class="text-center">
                                    ...
                                    <div class="mt-2 mb-3"
                                         v-if="form.initial_name === avatar_not_initial_name">
                                        <button type="button" class="btn btn-danger btn-sm" @click="removeAvatar">
                                            <i class="ri-delete-bin-fill align-bottom me-1"></i> {{ __('messages.remove') ?? 'Remove' }}
                                        </button>
                                    </div>
                            ...
                            <div class="col-xxl-9">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label for="level_slug" class="form-label">{{ __('messages.user_level') }} <span
                                                        class="text-danger">*</span></label>
                                            <select :class="['form-select', errors.level_slug ? 'is-invalid' : '']"
                                            ...
                                            <span class="invalid-feedback" v-if="errors.level_slug"><strong>@{{ errors.level_slug[0] }}</strong></span>
                                        </div>
                                    </div>
...
@push('scripts')
    <script>
        ...
        let currentLevelSlug = @json($currentLevelSlug);
    ...
    @vite('resources/js/views/settings/partner-users/edit.js')
@endpush
