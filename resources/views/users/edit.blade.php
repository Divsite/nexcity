                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <span class="invalid-feedback" v-if="errors.name"><strong>@{{ errors.username[0] }}</strong></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                ...
                                                <div class="form-text">{{ __('messages.leave_empty_to_keep_the_same') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mt-2">
                                            <button class="btn btn-primary btn-load" type="submit" :disabled="loading"
                                                    @click="submitForm()" :key="submit_form_key">
