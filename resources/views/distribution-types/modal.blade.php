<div>
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h6 class="mb-0">{{ __('messages.distribution_types') }}</h6>
                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" wire:model="is_active" id="distribution-type-active">
                            <label class="form-check-label" for="distribution-type-active">
                                {{ __('messages.active') }}
                            </label>
                        </div>
