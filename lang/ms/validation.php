...
return [
    ...
    'phone' => 'Ruangan :attribute mengandungi nombor yang tidak sah.',
    ...
    'attributes' => [
        ...
        'distribution_class_source_id' => 'sumber kelas agihan',
        ...
        'type' => 'jenis',
        'is_package' => 'pembayaran pakej',
        'is_input_family_members' => 'input data ahli keluarga',
        'representative_total_money' => 'jumlah penanggungjawab',
        'use_same_package_amount' => 'jumlah pakej sama',
        'package_amount_each' => 'jumlah setiap ahli',
        'package_members_count' => 'jumlah ahli keluarga',
        'package_payers' => 'senarai pembayar pakej',
        'package_payers.*.payer_name' => 'nama pembayar pakej',
        'package_payers.*.payer_phone' => 'telefon pembayar pakej',
        'package_payers.*.payer_email' => 'emel pembayar pakej',
        'package_payers.*.total_money' => 'jumlah wang pembayar pakej',
        'package_payers.*.total_rice' => 'jumlah beras pembayar pakej',
        'detail.is_rice' => 'bayaran beras',
        'distribution_class_id' => 'kelas agihan',
        'officer_ids' => 'petugas',
        'recipient_ids' => 'penerima',
        'manual_recipients' => 'penerima manual',
        'manual_recipients.*.name' => 'nama penerima manual',
        'manual_recipients.*.phone' => 'telefon penerima manual',
